...
Richard TRÉZEUX
gan_data.py
Add the little subset of data (supposed to be generated by a GAN or a Variational Autoencoder to the training dataset of every worker
