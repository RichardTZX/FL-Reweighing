...
class Config():
    def __init__(self, config_file = 'default.cfg'):
        ...
        # Sensitive attributes indice for ethics dataset
        self.sensitive_attribute = False #False if no ethics / "sensitive_attribute_name" otherwise
        ...
        with open(filename, 'r') as f:
            for line in f:
                ...
                try:
                    ...
                    elif line[0] == 'sensitive_attribute':
                        self.sensitive_attribute = str(line[1])
