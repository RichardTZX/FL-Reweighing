        ...
        for c in clients:
            ...
            try:
                ...
                if self.cfg.sensitive_attribute:
                    simulate_time_c, comp, num_samples, update, acc, loss, disp_imp, gradiant, update_size, seed, shape_old, loss_old = c.train(start_t, num_epochs, batch_size, minibatch)
                    disp_imps.append(disp_imp)
                    sys_metrics[c.id]['disparate_impact'] = disp_imp
                else:
